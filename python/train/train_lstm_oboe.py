...
def collect_dataset(oboe_dir, dt, hist_len, pred_horizon, max_traces, to_kbps=False):
...
def main():
    ...
    ap.add_argument("--save_path", default=os.path.join(os.getcwd(), "assets", "models", "oboe_lstm.pt"))
